...
struct item_map_row item_map_table[] = {
    ...
    {"pictograph box", &z2_file.items[Z2_SLOT_PICTOGRAPH_BOX],
    ...
    {"great fairy sword", &z2_file.items[Z2_SLOT_GREAT_FAIRY_SWORD],
...
struct item_map_row mask_map_table[] = {
    ...
    {"fierce deity", &z2_file.masks[Z2_SLOT_FIERCE_DEITY],
