...
void guLookAtF(MtxF *mf, float eye_x, float eye_y, float eye_z, float at_x,
               float at_y, float at_z, float up_x, float up_y, float up_z) {
  ...
  *mf = (MtxF)guDefMtxF(right.x, up.x, -forward.x, 0.0f, right.y, up.y,
                        -forward.y, 0.0f, right.z, up.z, -forward.z, 0.0f,
...
void guTranslateF(MtxF *mf, float x, float y, float z) {
  *mf = (MtxF)guDefMtxF(1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f,
                        0.f, x, y, z, 1.f);
}
...
void guScaleF(MtxF *mf, float x, float y, float z) {
  *mf = (MtxF)guDefMtxF(x, 0.f, 0.f, 0.f, 0.f, y, 0.f, 0.f, 0.f, 0.f, z, 0.f,
                        0.f, 0.f, 0.f, 1.f);
}