...
static const char *resource_names[R_KZ_END] = {
    "checkbox", "icons",   NULL,    NULL,     NULL,    NULL, NULL,     "font",
    "buttons",  "amounts", "flags", "arrows", "files", NULL, "kzflex", "sd",
};
...
void *grc_ctor(int resource_id) {
  ...
  kztext->tile_size =
      (kztext->tile_width * kztext->tile_height * G_SIZ_BITS(kztext->img_size) +
       63) /
      64 * 8;
  return kztext;
}
...
static void *resource_buttons_ctor(int resource_id) {
  texture_loader loader = {
      0xF60, 32, 32, z2_parameter_static, G_IM_FMT_IA, G_IM_SIZ_8b, 0,
      0,     1,  5,  SOURCE_FILE,
  };
...
static void *resource_dungeon_items_ctor(int resource_id) {
  texture_loader loader = {
#if Z2_VERSION == NZSE
      0,  24, 24, z2_icon_item_24_static, G_IM_FMT_RGBA, G_IM_SIZ_32b, 0,
      13, 1,  0,  SOURCE_ARCHIVE,
#else
      0,
      24,
      24,
      z2_icon_item_24_static,
      G_IM_FMT_RGBA,
      G_IM_SIZ_32b,
      0,
      0,
...
static void *resource_rupee_ctor(int resource_id) {
  texture_loader loader = {RUPEE_OFFSET,
                           16,
                           16,
                           z2_parameter_static,
                           G_IM_FMT_IA,
...
#endif
  struct item_texture *item =
      (struct item_texture *)resource_get(R_Z2_ITEMS) + item_id;
#ifdef LITE
...
void kz_resource_init() {
  static menu_sprite_t up_sprite = {
      NULL,          0, 0, DEFAULT_COLOR, DEFAULT_COLOR, 8, 8, NULL,
      DEFAULT_COLOR, 0, 0, NULL,
  };

  static menu_sprite_t down_sprite = {
      NULL,          1, 0, DEFAULT_COLOR, DEFAULT_COLOR, 8, 8, NULL,
      DEFAULT_COLOR, 0, 0, NULL,
  };

  static menu_sprite_t export_sprite = {
      NULL, 1, 1, DEFAULT_COLOR, DEFAULT_COLOR, 12, 12, NULL, 0, 0, 0, NULL};

  static menu_sprite_t import_sprite = {
      NULL, 0, 0, DEFAULT_COLOR, DEFAULT_COLOR, 12, 12, NULL, 0, 0, 0, NULL};
